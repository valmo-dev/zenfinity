    ...
    <div class="glass-card rounded-2xl overflow-hidden">
      ...
      <div class="px-6 py-4 border-b border-white/5 bg-gradient-to-r from-amber-500/10 to-transparent">
        <div class="flex items-center justify-between">
          ...
          <span class="px-4 py-1.5 rounded-full text-sm font-bold bg-amber-500/20 text-amber-400">
      ...
      <div class="p-6">
        <div v-if="store.communalChargeItems.length > 0">
          ...
          <div class="mt-6 pt-4 border-t border-white/5">
            <div class="flex items-center gap-3 mb-4">
              ...
              <span class="text-xs font-medium text-white/40 uppercase tracking-wider">Répartition</span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              >
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-white/40 text-xs">({{ store.communalChargesDistribution[owner] }}%)</span>
                </div>
        ...
        <div v-else class="text-center py-8">
          ...
          <p class="text-white/40 text-sm">Aucune charge commune</p>
        </div>
      </div>
    </div>
        ...
        <div class="p-6">
          <div v-if="store.personalChargeItems(owner).length > 0" class="space-y-2">
            ...
            >
              ...
              <div class="flex items-center gap-3">
                <span class="tabular-nums font-mono text-red-400/80">
                  −{{ formatCurrency(item.amount) }} €
                </span>
                <div class="opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                  <button
          ...
          <div v-else class="text-center py-8">
            ...
            <p class="text-white/40 text-sm">Aucune charge personnelle</p>
          </div>
        </div>
      </div>
    </div>
